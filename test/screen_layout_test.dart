    ...
    await tester.runAsync(() async {
      ...
      await Future.wait(<Future<Object?>>[
        for (final future in <Future<Object?>>[
          ...
          container.read(recurringRulesProvider.future),
          container.read(creditsProvider.future),
          container.read(creditsSummaryProvider.future),
          container.read(peopleProvider.future),
          container.read(personGroupsProvider.future),
          container.read(splitsProvider.future),
          container.read(
