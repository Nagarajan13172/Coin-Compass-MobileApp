    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          const _Section(child: _ProfileCard()),
          ...
          switch (settings) {
            ...
            AsyncValue(:final valueOrNull?) => Column(
              children: [
                ...
                _Section(child: _SecurityCard(settings: valueOrNull)),
              ],
            ),
...
/// name" below is `settings.name`, which is a different field entirely.
              ...
              for (final option in const [
                ...
                Expanded(
                  child: _ThemeOption(
                    ...
                    busy:
                        pending == SettingsWrite.theme && mode == option.$1,
                    onTap: pending != null
                        ? null
          ...
          if (currencies.isEmpty)
            ...
            for (var i = 0; i < currencies.length; i++) ...[
              ...
              _CurrencyRow(
                ...
                onTap:
                    (blocked || currencies[i].code == settings.baseCurrency)
                    ? null
